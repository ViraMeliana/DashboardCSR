...
class UsersController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = User::with(['roles','positions'])->select(sprintf('%s.*', (new User())->table));
            ...
            $table->editColumn('positions', function ($row) {
                return $row->positions ? $row->positions->name : '';
            });
    ...
    public function edit(User $user)
    {
        ...
        return view('admin.users.edit', compact('roles', 'user','positions'));
    }
