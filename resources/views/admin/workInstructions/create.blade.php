...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.workInstruction.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.work-instructions.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        <label class="required" for="no_urut">{{ trans('cruds.workInstruction.fields.no_urut') }}</label>
                        <input class="form-control {{ $errors->has('no_urut') ? 'is-invalid' : '' }}" type="number" name="no_urut" id="no_urut" value="{{ old('no_urut', '') }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('no_ik') ? 'is-invalid' : '' }}" type="number" name="no_ik" id="no_ik" value="{{ old('no_ik', '') }}" required>
                        @if($errors->has('no_ik'))
                            <div class="invalid-feedback">
                                {{ $errors->first('no_ik') }}
                            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('work_unit') ? 'is-invalid' : '' }}" type="text" name="work_unit" id="work_unit" value="{{ old('work_unit', '') }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('publish_date') ? 'is-invalid' : '' }}" type="date" name="publish_date" id="publish_date" value="{{ old('publish_date', '') }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('reassessment_date') ? 'is-invalid' : '' }}" type="date" name="reassessment_date" id="reassessment_date" value="{{ old('reassessment_date', '') }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('check_date') ? 'is-invalid' : '' }}" type="date" name="check_date" id="check_date" value="{{ old('check_date', '') }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('tindakan') ? 'is-invalid' : '' }}" type="text" name="tindakan" id="tindakan" value="{{ old('tindakan', '') }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <textarea class="form-control {{ $errors->has('keterangan') ? 'is-invalid' : '' }}" type="number" name="keterangan" id="keterangan" required>{{ old('keterangan', '') }}</textarea>
