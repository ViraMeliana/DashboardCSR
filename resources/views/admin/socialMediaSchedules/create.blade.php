    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("admin.social-media-schedules.store") }}" enctype="multipart/form-data">
                    @csrf
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small class="text-muted">{{ trans('cruds.socialMediaSchedules.fields.date_helper') }}</small></p>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small class="text-muted">{{ trans('cruds.socialMediaSchedules.fields.event_helper') }}</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small class="text-muted">{{ trans('cruds.socialMediaSchedules.fields.description_helper') }}</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small class="text-muted">{{ trans('cruds.socialMediaSchedules.fields.type_helper') }}</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small class="text-muted">{{ trans('cruds.socialMediaSchedules.fields.media_helper') }}</small></p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('caption') ? 'is-invalid' : '' }}" name="caption" id="caption">{{ old('caption') }}</textarea>
