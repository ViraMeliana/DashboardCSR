        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        {{ trans('global.create') }} {{ trans('cruds.businessPartnerIdentification.title_singular') }}
                    </h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route("admin.business-partner-identifications.store") }}" enctype="multipart/form-data">
                                ...
                                <div class="mb-1">
                                    ...
                                    <select class="form-control select2 {{ $errors->has('business_partner') ? 'is-invalid' : '' }}" name="business_partner_id" id="business_partner_id" required>
                                        @foreach($business_partners as $id => $entry)
                                            <option value="{{ $id }}" {{ old('business_partner_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('business_partner_name') ? 'is-invalid' : '' }}" type="text" name="business_partner_name" id="business_partner_name" value="{{ old('business_partner_name', '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('smap_implementation') ? 'is-invalid' : '' }}" name="smap_implementation" id="smap_implementation" required>{{ old('smap_implementation') }}</textarea>
                                ...
                                <div class="mb-1">
                                    ...
                                    @foreach(App\Models\BusinessPartnerIdentification::SELF_SMAP_CONTROL_RADIO as $key => $label)
                                        <div class="form-check {{ $errors->has('self_smap_control') ? 'is-invalid' : '' }}">
                                            <input class="form-check-input" type="radio" id="self_smap_control_{{ $key }}" name="self_smap_control" value="{{ $key }}" {{ old('self_smap_control', '') === (string) $key ? 'checked' : '' }} required>
