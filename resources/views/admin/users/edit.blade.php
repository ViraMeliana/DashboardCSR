                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('identity') ? 'is-invalid' : '' }}" type="text" name="identity" id="identity" value="{{ old('identity', $user->identity) }}" required>
                                    ...
                                    @endif
                                    <p><small
                                            class="text-muted">{{ trans('cruds.user.fields.name_helper') }}</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small
                                            class="text-muted">{{ trans('cruds.user.fields.email_helper') }}</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    @endif
                                    <p><small
                                            class="text-muted">{{ trans('cruds.user.fields.password_helper') }}</small>
                                    </p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <select class="form-control select2 {{ $errors->has('position_id') ? 'is-invalid' : '' }}" name="position_id" id="position_id" required>
                                        @foreach($positions as $id => $entry)
                                            <option value="{{ $id }}" {{ (old('position_id') ? old('position_id') : $user->position_id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                        @endforeach
                                    </select>
