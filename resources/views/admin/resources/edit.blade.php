                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $resource->name) }}" required>
                                    @if($errors->has('name'))
                                    ...
                                    @endif
                                    <p><small
                                            class="text-muted">{{ trans('cruds.resource.fields.name_helper') }}</small>
                                    </p>
                                </div>
                            </div>
                        </div>
