...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tjsl.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tjsl-insidentils.update", [$tjsl_insidentil->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('periode') ? 'is-invalid' : '' }}" type="number" name="periode" id="periode" value="{{ old('periode', $tjsl_insidentil->periode) }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('rka') ? 'is-invalid' : '' }}" type="number" name="rka" id="rka" value="{{ old('rka', $tjsl_insidentil->rka) }}" required>
                        @if($errors->has('rka'))
                            <div class="invalid-feedback">
                                {{ $errors->first('rka') }}
                            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('cash_out') ? 'is-invalid' : '' }}" type="number" name="cash_out" id="cash_out" value="{{ old('cash_out', $tjsl_insidentil->cash_out) }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('commited') ? 'is-invalid' : '' }}" type="number" name="commited" id="commited" value="{{ old('commited', $tjsl_insidentil->commited) }}" required>
            ...
            <div class="row">
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <input class="form-control {{ $errors->has('realization') ? 'is-invalid' : '' }}" type="number" name="realization" id="realization" value="{{ old('realization', $tjsl_insidentil->realization) }}" required>
                ...
                <div class="col-xl-12 col-md-12 col-12">
                    <div class="mb-1">
                        ...
                        <select class="form-control {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category" id="category" required>
                            <option value disabled {{ old('category', $tjsl_insidentil->category) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                            @foreach(App\Models\TjslInsidentil::TYPE_CATEGORY as $key => $label)
                                <option value="{{ $key }}" {{ old('category', $tjsl_insidentil->category) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                            @endforeach
                        </select>
