        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">
                        {{ trans('global.create') }} {{ trans('cruds.humanResource.title_singular') }}
                    </h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route("admin.human-resources.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('competence') ? 'is-invalid' : '' }}" type="text" name="competence" id="competence" value="{{ old('competence', '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('awareness') ? 'is-invalid' : '' }}" type="text" name="awareness" id="awareness" value="{{ old('awareness', '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('scope') ? 'is-invalid' : '' }}" name="scope" id="scope" required>{{ old('scope') }}</textarea>
                                    @if($errors->has('scope'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('scope') }}
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('jobdesc') ? 'is-invalid' : '' }}" name="jobdesc" id="jobdesc" required>{{ old('jobdesc') }}</textarea>
