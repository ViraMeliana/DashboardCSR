                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('risk_name') ? 'is-invalid' : '' }}" type="text" name="risk_name" id="risk_name" value="{{ old('risk_name', '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('risk_process') ? 'is-invalid' : '' }}" name="risk_process" id="risk_process" required>{{ old('risk_process') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('likelihood_baseline') ? 'is-invalid' : '' }}" type="text" name="likelihood_baseline" id="likelihood_baseline" value="{{ old('likelihood_baseline', '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('consequences_baseline') ? 'is-invalid' : '' }}" type="text" name="consequences_baseline" id="consequences_baseline" value="{{ old('consequences_baseline', '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('iso') ? 'is-invalid' : '' }}" name="iso" id="iso" required>{{ old('iso') }}</textarea>
                                    @if($errors->has('iso'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('iso') }}
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('existing_control') ? 'is-invalid' : '' }}" name="existing_control" id="existing_control" required>{{ old('existing_control') }}</textarea>
                                ...
                                <div class="mb-1">
                                    ...
                                    @foreach(App\Models\Risk::EFFECTIVENESS_RADIO as $key => $label)
                                        <div class="form-check {{ $errors->has('effectiveness') ? 'is-invalid' : '' }}">
                                            <input class="form-check-input" type="radio" id="effectiveness_{{ $key }}" name="effectiveness" value="{{ $key }}" {{ old('effectiveness', '') === (string) $key ? 'checked' : '' }} required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('risk_cause') ? 'is-invalid' : '' }}" name="risk_cause" id="risk_cause" required>{{ old('risk_cause') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('proactive_mitigation') ? 'is-invalid' : '' }}" name="proactive_mitigation" id="proactive_mitigation" required>{{ old('proactive_mitigation') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('likelihood_target') ? 'is-invalid' : '' }}" type="text" name="likelihood_target" id="likelihood_target" value="{{ old('likelihood_target','') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('consequences_target') ? 'is-invalid' : '' }}" type="text" name="consequences_target" id="consequences_target" value="{{ old('consequences_target', '') }}" required>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control {{ $errors->has('reactive_mitigation') ? 'is-invalid' : '' }}" name="reactive_mitigation" id="reactive_mitigation">{{ old('reactive_mitigation') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-12">
                                <div class="mb-1">
                                    ...
                                    <input class="form-control {{ $errors->has('time_schedule') ? 'is-invalid' : '' }}" type="text" name="time_schedule" id="time_schedule" value="{{ old('time_schedule', '') }}" required>
